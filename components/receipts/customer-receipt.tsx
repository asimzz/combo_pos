...
export function CustomerReceipt({
          ...
          <html>
            <head>
              ...
              <style>
                ...
                .item-row { display: flex; justify-content: between; margin: 5px 0; }
                .item-name { flex: 1; }
                .item-price { text-align: right; }
                .total-row { font-weight: bold; font-size: 14px; }
                .qr-section { text-align: center; margin: 15px 0; }
                .qr-code { margin: 5px; }
                .payment-options { background: #f5f5f5; padding: 8px; margin: 5px 0; border-radius: 4px; }
                .ussd-code { font-family: monospace; font-weight: bold; }
  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ref={printRef}
        className="receipt bg-white p-6 border border-gray-300 max-w-sm mx-auto"
      >
        {/* Header */}
        ...
        {/* Order Details */}
        <div className="mb-4">
          <div className="order-number text-center text-lg font-bold mb-2">
        ...
        <div className="mb-4 space-y-1">
          ...
          <div className="flex justify-between font-bold text-lg total-row">
            <span>TOTAL:</span>
        ...
        <div className="qr-section space-y-4">
          {momoQR && order.paymentMethod === "MOMO" && (
            <div className="text-center">
              <div className="text-xs font-medium mb-2">MoMo Payment</div>
              <img
                src={momoQR}
                alt="MoMo Payment QR"
